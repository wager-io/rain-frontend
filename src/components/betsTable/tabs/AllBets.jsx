  ...
  return (
    <div className="p-0 sm:p-0">
      ...
      >
            ...
            return (
              <div
                ...
                onMouseEnter={(e) => {
                  if (isCardRow) {
                    ...
                    e.target.style.boxShadow = '0 2px 8px var(--shadow-purple)'
                  } 
                }}
                onMouseLeave={(e) => {
                  e.target.style.backgroundColor = isCardRow ? 'var(--tertiary-bg)' : 'transparent'
              ...
              >
                ...
                <div className="flex items-center justify-end sm:justify-end gap-2 col-span-1">
                  ...
                  <div 
                    className="transition-transform border duration-200 bg-[var(--hover-bg)] rounded p-1"
                    style={{ 
                      color: bet.payout > 0 ? 'var(--success-green)' : 'var(--text-dark)',
                      borderColor: "var(--border-color)"
                    }}
                  >
                    {bet.payout > 0 ? 
        ...
        {/* Mobile Info */}
        <div className="sm:hidden p-4 text-center border-t" style={{ borderTopColor: 'var(--border-color)' }}>
