...
import UsersBetLayout from '../../components/betsTable/Layout';
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center">
            ...
            <div>
              ...
              >
                {isLoggedIn ? favouriteGames.length : ""} favourite games
              </p>
            </div>
          </div>
          ...
          {favouriteGames.length > 0 && (
            <div className="flex border rounded-[30px] px-2 border-[var(--text-color)] overflow-hidden">
              <button 
                onClick={handlePrev}
                className="flex items-center justify-center cursor-pointer rounded-[30px] p-2 text-[var(--text-color)] transition-colors"
              >
              ...
              <button 
                onClick={handleNext}
                className="flex items-center justify-center rounded-[30px] cursor-pointer p-2 text-[var(--text-color)] transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
